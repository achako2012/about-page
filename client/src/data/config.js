module.exports = {
    ...
    "skillList": [
        {
            id: 1,
            skill: "Clear understanding of software development life cycle"
        },
        {
            id: 2,
            skill: "Knowledge of test types and levels, test design techniques"
        },
        {
            id: 3,
        ...
        {
            id: 5,
            skill: "Experience with JIRA bug-tracking system"
        }
    ],
