...
export const Navbar: React.FC<NavbarProps> = ({ onClickModal }) => {
  ...
  const loginButtons = (
    <div className="login-buttons">
      <button className="authenticate-button-login" type="button" onClick={ onClickModal }>alex</button>
  ...
  const logoutButtons = (
    <div className="logout-buttons">
      <button className="authenticate-button-logout" type="button" onClick={ () => auth.logout() }>logout
      </button>
