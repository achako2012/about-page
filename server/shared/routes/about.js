...
import { addAbout, addExperience, addSkill, deleteAboutById, deleteExperienceById, deleteSkillById, getAbout, getExperience, getSkills } from "../controllers/customer-api-controller.js";
const router = Router();
