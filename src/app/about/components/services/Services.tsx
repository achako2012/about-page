        ...
        <div className="services">
          ...
          <div className="services-cards-wrapper">
            <Card body>
              ...
              <CardText>
                Huge experience with different testing frames and libraries.
                Good experience with stack around - CI/CD systems. Writing test
                cases, determining priority of bugs, using different test
                approaches and many other.
              </CardText>
            </Card>
            <Card body>
              <IconContext.Provider value={reactIconsClass}>
              ...
              <CardText>
                ...
                others. Experience with building services with Express and
                MongoDB tools.
              </CardText>
            </Card>
          </div>
